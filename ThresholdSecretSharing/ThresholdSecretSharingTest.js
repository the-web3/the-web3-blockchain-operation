 ...
 * @LastEditTime: 2024-06-07 23:30:19
...
function hexStringToUint8Array(hexString) {
    ...
    return new Uint8Array(chunks.map(function (chunk) {
...
//验证 逆异或算法
console.log("key:" +
    uint8ArrayToHexString(shareToSecret(head_body[0], hexStringToUint8Array(body_recover))));
